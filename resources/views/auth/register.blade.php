          ...
          <div class="mb-5">
            ...
            <div class="relative">
              ...
              <textarea id="alamat" name="alamat" rows="3"
                ...
                placeholder="Your complete address">{{ old('alamat') }}</textarea>
            </div>
            @error('alamat')
              <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
          ...
          <div class="mb-5">
            ...
            <div class="relative">
              ...
              <button type="button" onclick="togglePassword('password')"
                ...
                <svg id="eyeIconPassword" class="w-5 h-5 text-gray-400 hover:text-gray-600" fill="none"
          ...
          <div class="mb-5">
            ...
            <div class="relative">
              ...
              <button type="button" onclick="togglePassword('password_confirmation')"
                class="absolute inset-y-0 right-0 pr-3 flex items-center">
                <svg id="eyeIconPasswordConfirmation" class="w-5 h-5 text-gray-400 hover:text-gray-600" fill="none"
                  stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
