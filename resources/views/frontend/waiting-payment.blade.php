...
@section('content')
<section class="py-8 sm:py-12 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 min-h-screen flex items-center justify-center">
  <div class="max-w-3xl mx-auto px-4 sm:px-6">
    ...
    <div class="text-center mb-6">
      <div class="inline-block relative">
        ...
        <div class="absolute inset-0 bg-gray-500 rounded-full opacity-20 animate-ping animation-delay-200"></div>

        {{-- Icon --}}
        <div class="relative bg-gradient-to-br from-gray-700 to-gray-900 p-6 rounded-full shadow-2xl animate-bounce-slow">
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
      ...
      <div class="bg-gradient-to-r from-gray-800 to-gray-900 px-6 py-5">
        <h1 class="text-xl sm:text-2xl font-extrabold text-white text-center mb-1">
          Waiting for Payment
        </h1>
      ...
      <div class="p-5 sm:p-6">
        {{-- Order Info & Payment Status - Side by Side --}}
          ...
          <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4">
            <div class="grid grid-cols-2 gap-3 text-center">
              <div>
                ...
                <p class="text-base font-bold text-gray-900">#<span id="orderId">{{ str_pad($orderId, 6, '0', STR_PAD_LEFT) }}</span></p>
              </div>
              <div>
                <p class="text-xs text-gray-600 mb-1">Total Payment</p>
                <p class="text-base font-bold text-gray-900">{{ $pemesanan->pembayaran->jumlah_bayar_formatted ?? 'Rp 0' }}</p>
              </div>
            </div>
          </div>

          {{-- Payment Status --}}
          <div class="flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4">
            <div id="paymentStatus" class="inline-flex items-center gap-2 px-4 py-2 bg-yellow-100 text-yellow-800 rounded-full">
              <svg class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
              </svg>
              <span class="font-semibold text-sm">Waiting...</span>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white border-2 border-gray-200 rounded-xl p-5 mb-5">
          ...
          <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-4 mb-4">
            <p class="text-xs text-gray-600 mb-2 text-center">Virtual Account Number</p>
            <div class="flex items-center justify-center gap-2">
              <p class="text-xl font-mono font-bold text-gray-900 tracking-wider" id="vaNumber">
                {{ $pemesanan->pembayaran->xendit_account_number }}
              </p>
              <button onclick="copyVA()" class="p-2 hover:bg-gray-200 rounded-lg transition" title="Copy VA Number">
          ...
          <div class="mb-3">
            <a href="{{ $pemesanan->pembayaran->xendit_payment_url }}" target="_blank"
               class="w-full inline-flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-gray-700 to-gray-900 text-white rounded-lg hover:from-gray-800 hover:to-black transition font-bold shadow-md">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>
              </svg>
              Complete Payment Now
            </a>
            <p class="text-center text-xs text-gray-500 mt-2">Click button to open payment page</p>
          </div>
          @endif
          ...
          <div class="text-center mb-3">
            <p class="text-xs text-gray-600 mb-2">Scan QR Code to Pay</p>
            <div class="inline-block p-3 bg-white rounded-lg shadow-sm">
              <img src="{{ $pemesanan->pembayaran->xendit_qr_url }}" alt="QR Code" class="w-40 h-40 mx-auto">
            </div>
          </div>
          @endif
          ...
          <div class="flex items-center justify-center gap-2 text-xs text-orange-700 bg-orange-50 rounded-lg py-2 px-3">
        ...
        {{-- Payment Instructions & Action Buttons in 2 Columns --}}
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="bg-gray-50 border border-gray-200 rounded-xl p-4">
            ...
            <ul class="space-y-2 text-xs text-gray-700">
              <li class="flex items-start gap-2">
                ...
                <span>Complete payment using selected method</span>
              </li>
              <li class="flex items-start gap-2">
                <svg class="w-4 h-4 text-green-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
              ...
              <li class="flex items-start gap-2">
                ...
                <span>Auto-redirect when confirmed</span>
              </li>
            </ul>
          </div>
          ...
          <div class="flex flex-col gap-3">
            <a href="{{ route('my-orders') }}"
               class="inline-flex items-center justify-center gap-2 px-5 py-3 border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition font-bold text-sm">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button onclick="checkPaymentStatus()"
                    class="inline-flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-gray-700 to-gray-900 text-white rounded-lg hover:from-gray-800 hover:to-black transition font-bold shadow-md text-sm">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
