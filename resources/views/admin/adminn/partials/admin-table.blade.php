{{-- resources/views/admin/adminn/partials/admin-table.blade.php --}}
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end space-x-2">
                                    <a href="{{ route('admin.adminn.show', $item->id_admin) }}" 
                                    ...
                                    <a href="{{ route('admin.adminn.edit', $item->id_admin) }}" 
                                    ...
                                    <form action="{{ route('admin.adminn.destroy', $item->id_admin) }}" 
                                          method="POST" 
                                          class="inline"
...
@else
    <div class="text-center py-12">
        ...
        <h3 class="text-lg font-medium text-gray-900 mb-2">Tidak ada admin ditemukan</h3>
