...
@section('title', 'Tambah Admin - Konveksi')
...
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-yellow-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-3">Tambah Admin Baru</h1>
            <p class="text-gray-600 text-lg">Tambahkan administrator baru ke sistem</p>
        </div>

        <!-- Form Card -->
        <div class="bg-white/80 glass rounded-2xl shadow-xl border border-white/20 overflow-hidden">
            <div class="p-6 sm:p-8">
                <form action="{{ route('admin.adminn.store') }}" method="POST" id="adminForm" class="space-y-6">
                    @csrf
