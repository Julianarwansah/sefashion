...
@section('title', 'Edit Customer - Konveksi')
...
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-yellow-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-3">Edit Data Customer</h1>
            <p class="text-gray-600 text-lg">Perbarui informasi customer</p>
        </div>

        <!-- Form Card -->
        <div class="bg-white/80 glass rounded-2xl shadow-xl border border-white/20 overflow-hidden">
            <div class="p-6 sm:p-8">
                <form action="{{ route('admin.customer.update', $customer->id_customer) }}" method="POST" id="editForm" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                        <label class="block text-sm font-semibold text-yellow-800 mb-3">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            // Client-side validation for password if filled
        ...
        [passwordField, confirmPasswordField].forEach(field => {
            field.addEventListener('input', function() {
                if (passwordField.value && confirmPasswordField.value) {
                    ...
                    confirmPasswordField.classList.remove('border-green-500', 'focus:border-green-500', 'focus:ring-green-200', 'border-red-500', 'focus:border-red-500', 'focus:ring-red-200');
                }
            });
        });
    });
