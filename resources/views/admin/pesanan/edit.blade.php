...
@section('title', 'Edit Pesanan - Konveksi')
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
            <div>
                <nav class="flex mb-4" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-2 text-sm">
                        ...
                        <li class="flex items-center">
                            ...
                            <a href="{{ route('admin.pesanan.show', $pesanan->id_pemesanan) }}" class="ml-2 text-purple-600 hover:text-purple-700">
                ...
                <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Edit Pesanan</h1>
                <p class="text-gray-600 text-lg">#{{ $pesanan->id_pemesanan }} - {{ $pesanan->customer->nama_customer ?? 'N/A' }}</p>
            </div>
            <div class="flex flex-col sm:flex-row gap-3">
                <a href="{{ route('admin.pesanan.show', $pesanan->id_pemesanan) }}" 
                   class="inline-flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="tanggal_pemesanan" id="tanggal_pemesanan" 
                                   ...
                                   value="{{ old('tanggal_pemesanan', $pesanan->tanggal_pemesanan->format('Y-m-d\TH:i')) }}" 
                                   required>
                        ...
                        <div>
                            ...
                            <select name="status" id="status" 
                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-purple-200 focus:border-purple-400 transition-all duration-300 @error('status') border-red-500 focus:border-red-500 focus:ring-red-200 @enderror" 
                                    required>
                            ...
                            <div class="item-row bg-gray-50 rounded-xl p-6 border-2 border-gray-200">
                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-end">
                                    ...
                                    <div class="lg:col-span-5">
                                        ...
                                        <select name="items[{{ $index }}][id_ukuran]" 
                                                ...
                                                required 
                                                onchange="getDetailUkuran(this, {{ $index }})">
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <input type="text" 
                                               class="w-full px-4 py-3 bg-gray-100 border-2 border-gray-200 rounded-xl harga-satuan-{{ $index }}" 
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <input type="number" 
                                               ...
                                               class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-purple-200 focus:border-purple-400 transition-all duration-300 jumlah-{{ $index }}" 
                                               min="1" 
                                               value="{{ $detail->jumlah }}" 
                                               required 
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <input type="text" 
                                               class="w-full px-4 py-3 bg-gray-100 border-2 border-gray-200 rounded-xl subtotal-{{ $index }}" 
                                               value="{{ $detail->subtotal_formatted }}" 
                                               readonly>
                                    </div>
                        ...
                        <div class="bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl p-6 text-white shadow-lg">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold" id="total-harga">{{ $pesanan->total_harga_formatted }}</p>
                                </div>
