    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3">
            <h5 class="card-title mb-0">
                <i class="fas fa-edit me-2 text-primary"></i>Form Pesanan
            </h5>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="tanggal_pemesanan" id="tanggal_pemesanan" 
                                   ...
                                   value="{{ old('tanggal_pemesanan', now()->format('Y-m-d\TH:i')) }}" required>
                ...
                <div id="items-container">
                    <div class="item-row row mb-3 border-bottom pb-3">
                        <div class="col-md-5">
                            ...
                            <select name="items[0][id_ukuran]" class="form-select select-ukuran" required onchange="getDetailUkuran(this, 0)">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control harga-satuan-0" readonly placeholder="Pilih produk">
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Jumlah <span class="text-danger">*</span></label>
                            <input type="number" name="items[0][jumlah]" class="form-control jumlah-0" min="1" value="1" required onchange="updateSubtotal(0)">
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Subtotal</label>
                            <input type="text" class="form-control subtotal-0" readonly placeholder="Rp 0">
                        </div>
                        <div class="col-md-1">
                            <label class="form-label">&nbsp;</label>
                            <button type="button" class="btn btn-danger btn-block w-100" onclick="removeItem(this)" disabled>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-end">
                                        <h4 class="text-success fw-bold mb-0" id="total-harga">Rp 0</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
